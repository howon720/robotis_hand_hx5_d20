...
TactileCorrectionPlanner::TactileCorrectionPlanner(TactileGraspController & controller)
...
bool TactileCorrectionPlanner::run_x_correction(
...
bool TactileCorrectionPlanner::run_y_correction(
